...
const Helper ={
  formTemplate : (studentName,gender,branch,subjects,phoneNumber,isEdit,changeHandler,changeCheckboxHandler,createInformation) => {
    return (
          ...
          {studentInfo.map((studentRecord, index) => {
            return (
              <tr>
                ...
                <td>
                  <button onClick={() => editInformation(index)}>
                    Edit
                  </button>
